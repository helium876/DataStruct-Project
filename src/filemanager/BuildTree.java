...
public class BuildTree extends JPanel {
	...
	public static ArrayList<String> findDups(File[] fileList) throws NoSuchAlgorithmException, IOException{
        //String[] dups = [];
        MessageDigest md5Digest = MessageDigest.getInstance("MD5");
        int dubs = 0;
        ArrayList<String> dupFiles = new ArrayList<String>();
